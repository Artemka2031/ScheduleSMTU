...
from admin_bot.Keyboards.mailing_kb import mailing_kb, EventTypeCallback
...
from admin_bot.Keyboards.send_keyboard_inl_kb import send_kb, SendKbTypeCallback
